...
/* Screen that pops up when a user selects the 
 * Saftey Tips option from the menu of the 
 * Map and Comments Screens*/
public class SafetyTips extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tv.setText(Html
				.fromHtml("<font size=9>How to safely lock your "
